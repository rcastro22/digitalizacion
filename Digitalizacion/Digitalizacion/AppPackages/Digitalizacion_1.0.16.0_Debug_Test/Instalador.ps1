...
Import-Certificate -FilePath '.\Digitalizacion_1.0.16.0_x64_Debug.cer' -CertStoreLocation 'Cert:\LocalMachine\Root'
...
Add-AppxPackage .\Digitalizacion_1.0.16.0_x64_Debug.appxbundle